...
@Data // Estructura de datos de lombog
@Entity // Denota comportamiento sobre la clase
@Table(name = "transactions") // Mapeo entre la clase de JAVA y la tabla en la base de datos
